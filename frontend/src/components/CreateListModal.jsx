...
export const CreateListModal = ({ isOpen, onClose, onCreate }) => {
  ...
  return (
    <div style={{
      ...
      <div className="glass-panel animate-fade-in" style={{ width: '100%', maxWidth: '400px', padding: '32px', position: 'relative' }}>
        ...
        <h2 style={{ fontSize: '1.5rem', marginBottom: '24px' }}>Nueva Lista</h2>
        <form onSubmit={handleSubmit}>
          <input
            ...
            type="text"
            placeholder="Nombre de la lista (ej. Compras)"
            value={name}
